...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.LastLoginTime = field.NewTime(tableName, "last_login_time")
	_sysUser.LastLoginIP = field.NewString(tableName, "last_login_ip")
	_sysUser.LoginCount = field.NewInt32(tableName, "login_count")
	_sysUser.Creator = field.NewString(tableName, "creator")
	_sysUser.CreateTime = field.NewTime(tableName, "create_time")
	_sysUser.Updater = field.NewString(tableName, "updater")
