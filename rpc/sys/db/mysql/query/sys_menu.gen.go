...
func newSysMenu(db *gorm.DB, opts ...gen.DOOption) sysMenu {
	...
	_sysMenu.ScopeID = field.NewInt64(tableName, "scope_id")
	...
	_sysMenu.NoCache = field.NewInt32(tableName, "no_cache")
	_sysMenu.Affix = field.NewInt32(tableName, "affix")
	_sysMenu.External = field.NewInt32(tableName, "external")
	_sysMenu.Hidden = field.NewInt32(tableName, "hidden")
	_sysMenu.Status = field.NewInt32(tableName, "status")
	_sysMenu.Creator = field.NewString(tableName, "creator")
	_sysMenu.CreateTime = field.NewTime(tableName, "create_time")
	_sysMenu.Updater = field.NewString(tableName, "updater")
...
type sysMenu struct {
	...
	ALL        field.Asterisk
	ID         field.Int64  // 菜单ID
	ScopeID    field.Int64  // 安全范围ID
	ParentID   field.Int64  // 父菜单ID (0表示根菜单)
	MenuName   field.String // 菜单名称
	MenuType   field.String // 菜单类型 (M-目录, C-菜单, F-按钮)
	Path       field.String // 路由路径
	Component  field.String // 组件路径
	Redirect   field.String // 重定向路径
	Icon       field.String // 菜单图标
	Sort       field.Int32  // 排序
	NoCache    field.Int32  // 是否缓存 (0-缓存, 1-不缓存)
	Affix      field.Int32  // 是否固定在标签栏 (0-否, 1-是)
	External   field.Int32  // 是否外部链接 (0-否, 1-是)
	Hidden     field.Int32  // 是否隐藏 (0-显示, 1-隐藏)
...
func (s *sysMenu) updateTableName(table string) *sysMenu {
	...
	s.NoCache = field.NewInt32(table, "no_cache")
	s.Affix = field.NewInt32(table, "affix")
	s.External = field.NewInt32(table, "external")
...
func (s *sysMenu) fillFieldMap() {
	...
	s.fieldMap["no_cache"] = s.NoCache
	s.fieldMap["affix"] = s.Affix
