...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		SysRoleScope:  newSysRoleScope(db, opts...),
		SysScope:      newSysScope(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		SysRoleScope:  q.SysRoleScope.clone(db),
		SysScope:      q.SysScope.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		SysRoleScope:  q.SysRoleScope.replaceDB(db),
		SysScope:      q.SysScope.replaceDB(db),
...
type queryCtx struct {
	...
	SysRole       ISysRoleDo
	SysRoleScope  ISysRoleScopeDo
	SysScope      ISysScopeDo
	SysUser       ISysUserDo
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		SysRoleScope:  q.SysRoleScope.WithContext(ctx),
		SysScope:      q.SysScope.WithContext(ctx),
