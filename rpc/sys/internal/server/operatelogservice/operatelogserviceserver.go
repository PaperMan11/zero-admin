...
import (
	...
	"zero-admin/rpc/sys/internal/logic/operatelogservice"
...
// 查询系统操作日志表详情
func (s *OperateLogServiceServer) QueryOperateLogDetail(ctx context.Context, in *sysclient.QueryOperateLogDetailReq) (*sysclient.OperateLog, error) {
	l := operatelogservicelogic.NewQueryOperateLogDetailLogic(ctx, s.svcCtx)
	return l.QueryOperateLogDetail(in)
}

// 查询系统操作日志表列表
func (s *OperateLogServiceServer) QueryOperateLogList(ctx context.Context, in *sysclient.QueryOperateLogListReq) (*sysclient.OperateLogListData, error) {
